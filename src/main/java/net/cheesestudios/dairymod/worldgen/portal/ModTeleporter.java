package net.cheesestudios.dairymod.worldgen.portal;

import net.cheesestudios.dairymod.block.ModBlocks;
import net.cheesestudios.dairymod.block.custom.ModPortalBlock;
...
public class ModTeleporter implements ITeleporter {
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            if (doSetBlock)
                destinationWorld.setBlock(destinationPos, ModBlocks.DAIRY_PORTAL.get().defaultBlockState(), 3); // places portal block where you spawn
