...
public class ModMenuTypes {
    ...
    public static final DeferredRegister<MenuType<?>> MENUS =
            DeferredRegister.create(ForgeRegistries.MENU_TYPES, DairyMod.MOD_ID);

    public static final RegistryObject<MenuType<DairyCondenserMenu>> DAIRY_CONDENSER_MENU =
            registryMenuType("dairy_condenser_menu", DairyCondenserMenu::new);
